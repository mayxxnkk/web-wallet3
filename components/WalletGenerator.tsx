    ...
    <div className="flex flex-col gap-4">
          ...
          {pathTypes.length === 0 && (
            <div className="flex gap-4 flex-col my-12">
              <div className="flex flex-col gap-2">
                <h1 className="animate-fadeInUp tracking-tighter text-4xl md:text-5xl font-black">
                  Nebula supports multiple blockchains
                </h1>
                <p className="animate-fadeInUp text-primary/80 font-semibold text-lg md:text-xl">
      ...
      {mnemonicWords && wallets.length > 0 && (
        <div className="group flex flex-col items-center gap-4 cursor-pointer rounded-lg border border-primary/10 p-8">
          ...
          >
            <h2 className="animate-fadeInUp text-2xl md:text-3xl font-bold tracking-tighter">
              Your Secret Phrase
            </h2>
            <Button
              onClick={() => setShowMnemonic(!showMnemonic)}
          ...
          {showMnemonic && (
            <div
              className="animate-fadeInUp flex flex-col w-full items-center justify-center"
              onClick={() => copyToClipboard(mnemonicWords.join(" "))}
            >
              <div className="animate-fadeInUp grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 justify-center w-full items-center mx-auto my-8">
              ...
              <div className="animate-fadeInUp text-sm md:text-base text-primary/50 flex w-full gap-2 items-center group-hover:text-primary/80 transition-all duration-300">
      ...
      {wallets.length > 0 && (
        <div className="animate-fadeInUp flex flex-col gap-8 mt-6">
          ...
          >
            {wallets.map((wallet: any, index: number) => (
              <div
                key={index}
                className="animate-fadeInUp flex flex-col rounded-2xl border border-primary/10"
              >
